...
const loadAllPosts = (category) => {
    ...
    .then(data =>  showAllPosts(data.posts))
}
loadAllPosts()
...
const showAllPosts = (posts) => {
    ...
    posts.forEach(post => {
        ...
        //div.classList.add('grid', 'gap-4','justify-center', 'grid-cols-1', 'sm:grid-cols-2', 'md:grid-cols-3', 'lg:grid-cols-4');
        div.classList.add('flex', 'gap-4','justify-between', 'grid-cols-1', 'sm:grid-cols-2', 'md:grid-cols-3', 'lg:grid-cols-4');

        div.innerHTML = `
         
        <div class="w-[600px] flex flex-col justify-center items-center border py-4 px-8 rounded-xl border-gray-700 m-2">
            <div>
            ...
            <div class="flex flex-col">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="p-2 rounded-full bg-sky-400 cursor-pointer text-white">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
